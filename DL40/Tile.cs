...
namespace DL40
{
    public class Tile : Entity
    {
        ...
        public bool arrow;
        public Tile(TextureDrawer[] texes_, Vector2 pos_, bool isSolid_, bool a_isHurty, bool isSlippy_, bool isDoory_, int activID_, string facing_, bool arrow_, string activated_ = null) : base(texes_, pos_)
        {
            arrow = arrow_;
            facing = facing_;
            isSolid = isSolid_;
